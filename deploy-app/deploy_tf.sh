...
EC2_BACKEND_HOST=$(terraform output -raw ec2_backend_public_ip)
EC2_FRONTEND_HOST=$(terraform output -raw ec2_frontend_public_ip)
RDS_ENDPOINT="jdbc:mysql://$(terraform output -raw rds_endpoint)/connectmessenger"
CLIENT_ID=$(terraform output -raw cognito_client_id)
COGNITO_CLIENT_SECRET=$(terraform output -raw cognito_client_secret)
COGNITO_ISSUER_URI="https://cognito-idp.us-east-1.amazonaws.com/$(terraform output -raw user-pool-id)"

COGNITO_CLIENT_NAME="my_app_client_terraform"
